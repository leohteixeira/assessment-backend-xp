...
import {
  ...
  makeFindCategoryController,
  makeFindCategoriesController,
  makeEditCategoryController,
  makeRemoveCategoryController
...
export const applyCategoryRoutes = (router: Router): void => {
  ...
  router.get(
    ...
    adaptRoute(makeFindCategoryController())
  )
  router.post(
    '/categories/add-category',
    adaptRoute(makeAddCategoryController())
  )
  router.put(
    '/categories/edit-category/:categoryId',
    adaptRoute(makeEditCategoryController())
  )
  router.delete(
    '/categories/delete-category/:categoryId',
    adaptRoute(makeRemoveCategoryController())
  )
}
